...
class AtariProcessor(Processor):
    def process_observation_fail(self, observation):
        return observation.astype # already formatted in the env
    ...
    def process_state_batch_fail(self, batch):
        return batch
...
parser.add_argument('--env-name', type=str, default='gym_smallworld:smallworld-v0')
...
# set a test policy. it won't work without one.
